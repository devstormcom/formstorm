...
{% else %}
    ...
    <button onclick="devstorm_Helper.loginBox();" type="button" class="btn btn-default navbar-btn"><span class="glyphicon glyphicon-asterisk"></span> Login mit devStorm</button>
    <ul>
